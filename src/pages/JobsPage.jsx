    ...
    <section className="bg-gray-100 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-700 font-light leading-relaxed mb-6">
          <strong>Sajal's Diet Falsafa</strong> Sajal’s Diet Falsafa একটি পুষ্টি
          সেবা প্রদানকারী প্রতিষ্ঠান যা ক্লিনিক্যাল নিউট্রিশন কনসাল্টেন্সি,
          কাউন্সেলিং, জনস্বাস্থ্য সচেতনতা ও পরিবেশ সচেতনতার মাধ্যমে সুস্বাস্থ্য
          রক্ষা ও রোগ প্রতিরোধ নিয়ে কাজ করে থাকে। এখন পর্যন্ত আমাদের কার্যক্রমের
          মাধ্যমে আমরা পুষ্টি সচেতনতার অধীনে নিয়ে এসেছি দেশে ও দেশের বাইরে অন্তত
          ৫ লক্ষ মানুষকে। আমাদের ক্লিনিক্যাল নিউট্রিশন কনসাল্টেন্সির পরিধি
          বিস্তৃত বাংলাদেশ সহ পৃথিবীর অন্তত ১৫টি দেশে, বিশেষভাবে বাংলাভাষী
          মানুষদের জন্য ডায়েট ফালসাফা একটি বিশ্বজনীন পুষ্টি সচেতনতা ও পরামর্শ
          প্রতিষ্ঠান হিসেবে সুনামের সাথে কাজ করছে।
        </p>
